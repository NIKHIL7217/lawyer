  ...
  <footer class="bg-[#0d2a52] text-white mt-16">
    <div class="max-w-7xl mx-auto px-6 py-14 grid md:grid-cols-4 gap-10">
      ...
      <div>
        ...
        <div class="flex gap-3 text-xl"><span>◉</span><span>◉</span><span>◉</span></div>
      </div>

      <div>
        <h4 class="font-bold text-lg mb-4">Newsletter Signup</h4>
        <input class="w-full px-4 py-3 rounded-xl text-slate-900 mb-3" placeholder="Enter your email">
        <button class="w-full bg-[#b9923f] py-3 rounded-xl font-semibold">Subscribe</button>
      </div>
    </div>
